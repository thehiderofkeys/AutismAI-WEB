                    ...
                    <Col className="d-flex justify-content-center mb-5">
                        <Description>
                            ...
                            <PieChart width={800} height={200}>
                                ...
                                >
                                    {
                                        accuracy.map((entry, index) => <Cell key={`cell-${index}`} fill={accuracyColor[index % COLORS.length]} />)
                                    }
                                ...
                                >
                                    {
                                        sensitivity.map((entry, index) => <Cell key={`cell-${index}`} fill={sensitivityColor[index % COLORS.length]} />)
                                    }
                                ...
                                >
                                    {
                                        specificity.map((entry, index) => <Cell key={`cell-${index}`} fill={specificityColor[index % COLORS.length]} />)
                                    }
                            ...
                            <GraphButtons>
                                <Button color="primary" className="my-3 mr-1" onClick={onStatsInfoClick}>
                                    Learn More
                                </Button>
